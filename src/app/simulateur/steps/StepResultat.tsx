...
export function StepResultat() {
  ...
  const { resultat, anneeCfe, cfeLigne25, regime } = store
    ...
    try {
      ...
      const saveRes = await fetch('/api/simulation', {
        ...
        body: JSON.stringify({
          ...
          referenceAvis: store.referenceAvis,
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-gray-50 rounded-lg p-4 space-y-2.5">
        ...
        {[
          { label: 'CFE payée (ligne 25)', value: fmt(cfeLigne25 ?? 0) },
          ...
          { label: 'Cotisation minimum (plancher)', value: fmt(store.cfeLigne189 ?? 0) },
